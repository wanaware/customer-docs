...
- Use clearly labeled sample Structure, Site, and Collection records.
...
| 0:22–0:50 | Add Structure | Open Structures, select **Add Structure**, choose the supported type, enter a unique sample name, select its parent when the type requires one, and save. |
| 0:50–1:20 | Add Element | Open Elements, select **Add Element**, enter a unique sample name, choose **Site**, and add the intended Structure Tag. Save and open the Element. |
...
| 1:42–2:12 | Add Collection | In Collections, select **Add Collection**, enter a unique sample name, select the intended Assets by identity, and save. |
...
Open Structures, select **Add Structure**, choose the supported type, enter a unique sample name, select its parent when the type requires one, and save.

Open Elements, select **Add Element**, enter a unique sample name, choose **Site**, and add the intended Structure Tag. Save and open the Element.

For a Site, review Site Assets and Location. Add only sanitized documentation assets and approved location data.

In Collections, select **Add Collection**, enter a unique sample name, select the intended Assets by identity, and save.
