...
**Status:** Pending sanitized capture, captions, Product review, Support review, and catalog-service verification
...
- Use a new sample Asset Type with no customer data.
...
| 0:48–1:18 | Field builder | Enter a unique sample name and purpose, add a clearly named section and field, and enable catalog support for a managed-choice field. Select **Save Draft**. |
...
Enter a unique sample name and purpose, add a clearly named section and field, and enable catalog support for a managed-choice field. Select **Save Draft**.
