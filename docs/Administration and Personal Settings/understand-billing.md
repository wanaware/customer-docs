---
title: Understand billing, usage, payments, and invoices
excerpt: Review Plans, Payment & Billing, Billing History, and the impact of subscription changes.
deprecated: false
hidden: false
metadata:
  title: Understand WanAware billing | WanAware Documentation
  description: Review WanAware plans, usage, payment settings, invoices, and subscription-change consequences.
  keywords:
    - billing
    - payment
    - invoice
...
screenshot-set: administration-billing
