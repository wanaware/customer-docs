...
excerpt: Start with the onboarding path that matches your role and current workspace.
deprecated: false
hidden: false
metadata:
  title: Choose your WanAware onboarding path | WanAware Documentation
  description: Choose between exploring an existing WanAware environment and building a new one.
  keywords:
    - explore WanAware
    - build environment
    - onboarding path
...
You are done when you can explain what the asset is and name one connected resource.
...
Email [support@wanaware.com](mailto:support@wanaware.com?subject=Choosing%20a%20WanAware%20onboarding%20path) with your company, role, page URL, timestamp and time zone, and what you need to accomplish. Never send passwords, credentials, tokens, or secret values.
